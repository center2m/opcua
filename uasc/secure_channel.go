...
func (s *SecureChannel) Send(svc interface{}, authToken *ua.NodeID, h func(interface{}) error) error {
	...
	ch, err := s.SendAsync(svc, authToken, respRequired)
	if err != nil {
		return err
	}
...
func (s *SecureChannel) SendAsync(svc interface{}, authToken *ua.NodeID, respReq bool) (resp chan Response, err error) {
...
func (s *SecureChannel) readChunk() (*MessageChunk, error) {
	...
	case "OPN":
		...
		if m.SecurityPolicyURI != uapolicy.SecurityPolicyNone {
