...
type handlerFunc func(*Server, *uasc.SecureChannel, interface{}) (interface{}, error)

func (s *Server) registerHandler(typeID uint16, f handlerFunc) {
	s.serviceHandlers[typeID] = f
}

func (s *Server) handleService(sc *uasc.SecureChannel, svc interface{}) {
	...
	if ok {
		...
		response, err = h(s, sc, svc)
	} else {
		if typeID == 0 {
			debug.Printf("unknown service %T. Did you call register?", svc)
		}
	...
	if err != nil {
		if statusCode, ok := err.(ua.StatusCode); ok {
			response = &ua.ServiceFault{ResponseHeader: responseHeader(0, statusCode)}
		} else {
			response = &ua.ServiceFault{ResponseHeader: responseHeader(0, ua.StatusBadUnexpectedError)}
		}
	}
...
func handleServiceFault(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
...
func handleFindServersRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleFindServersOnNetworkRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleGetEndpointsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleRegisterServerRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleRegisterServer2Request(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
//func handleOpenSecureChannelRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
//	debug.Printf("Handling %T\n", r)
//
...
// Handled in the UASC stack
//func handleCloseSecureChannelRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
//	debug.Printf("Handling %T\n", r)
//
...
func handleCreateSessionRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleActivateSessionRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCloseSessionRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCancelRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleAddNodesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleAddReferencesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleDeleteNodesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleDeleteReferencesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleBrowseRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleBrowseNextRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleTranslateBrowsePathsToNodeIDsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleRegisterNodesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleUnregisterNodesRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleQueryFirstRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleQueryNextRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleReadRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleHistoryReadRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleWriteRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleHistoryUpdateRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCallMethodRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCallRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleMonitoredItemCreateRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCreateMonitoredItemsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleMonitoredItemModifyRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleModifyMonitoredItemsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleSetMonitoringModeRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleSetTriggeringRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleDeleteMonitoredItemsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleCreateSubscriptionRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleModifySubscriptionRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleSetPublishingModeRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handlePublishRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleRepublishRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleTransferSubscriptionsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
...
func handleDeleteSubscriptionsRequest(s *Server, sc *uasc.SecureChannel, r interface{}) (interface{}, error) {
	debug.Printf("Handling %T\n", r)
